...
const createGlobalOffice = (name: string, lat: number, lng: number): LocationData => ({
...
const countryCoordinates = {
  ...
  "Antigua & Deps": [17.060816, -61.796428],
  ...
  "Bosnia Herzegovina": [43.915886, 17.679076],
  ...
  "Congo Democratic Republic": [-4.038333, 21.758664],
  ...
  "Ireland Republic": [53.41291, -8.24389],
  ...
  "St Kitts & Nevis": [17.357822, -62.782998],
...
const globalOffices = Object.entries(countryCoordinates)
  .filter(([country]) => country !== 'United States')
  .map(([country, [lat, lng]]) => createGlobalOffice(country, lat, lng));
